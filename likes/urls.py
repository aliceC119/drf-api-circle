...
urlpatterns = [
    ...
    path('likes/posts/<int:pk>/', views.LikePostDetail.as_view(), name='like-post'),
    path('likes/videoposts/', views.VideoPostLikeList.as_view(), name='video-post-like-list'),  # List all video post likes
    path('likes/videoposts/<int:pk>/', views.VideoPostLikeDetail.as_view(), name='video-post-like-detail'),
